# Developer Agreement Contribution pages
...
These pages are [updated nightly](https://github.com/digital-land/developer-agreement-contribution/actions) by the [GitHub Action](.github/workflows/run.yml).
